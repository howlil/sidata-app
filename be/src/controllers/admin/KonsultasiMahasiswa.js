...
import status from "../../config/typeEnum";
...
export const accJadwalKonsulProdi = async (req, res) => {
  try {
    ...
    if (!existingJadwal) {
      return res
        .status(404)
        .json({ success: false, message: "Jadwal konsultasi tidak ditemukan" });
    }
...
export const getDetailJadwalKonsulProdi = async (req, res) => {
